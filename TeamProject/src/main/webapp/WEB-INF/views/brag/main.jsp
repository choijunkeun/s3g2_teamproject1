...
<body>
	...
	<div class="row card p-4 mb-4">
		<div class="row">
			<a href="/brag/best"><h2 class="fw-bolder text-black p-2">BEST</h2></a>
		</div>
		<hr>
		<div class="row card-body">
			<div class="col-sm-7 mt-0" id="divider">
				<h3 class="fw-bolder text-dark pb-2">이 달의 혼밥</h3>
				<div class="card">
					<div class="card-header justify-content-between">
						...
						<div class="row">
							<div class='col-sm-3'>
								<button class="btn-sm border-0 bg-transparent text-danger mx-2 float-start"
									id="likebtn${bestbragList[0].articleNo }" onclick="toggleLikes(${bestbragList[0].articleNo})">
						...
						<td title="${bestbragList[2].title }"><a
							href="/brag/viewdetail/${bestbragList[2].articleNo }">
								...
								<div
									...
									style="vertical-align: middle; object-fit: cover; width: inherit">
									<img class="img-item " src="${bestbragList[2].content}" name="brag_content">
