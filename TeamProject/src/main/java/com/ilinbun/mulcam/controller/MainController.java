...
//				System.out.println("message = " + message);
	...
	public String infoUpdate(MultipartFile profileImg, String email, String nickname, String originPass, String password, int honbabLevel, HttpSession session) throws Exception {
		String msg = "";
		...
		try {
			if(originPass.equals(dbPass)) {
				...
				if (profileImgName.equals("")) {
					...
					File destFile = new File(path + profileImg.getOriginalFilename());
