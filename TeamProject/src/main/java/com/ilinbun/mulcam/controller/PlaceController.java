...
public class PlaceController {
	...
	public ResponseEntity<String> test() {
		...
		StringBuffer response = new StringBuffer();
		try {
			URL url = new URL("https://dapi.kakao.com/v2/local/search/keyword.json" + "?page=1&" + "query=" + URLEncoder.encode("용산구()", "UTF-8"));
			...
			//StringBuffer response = new StringBuffer(getPlacesFromKakaoAPI("카카오프렌즈"));
	...
	public String getPlacesRAWResultFromKakao(String keyword, int page) {
		...
		StringBuffer response = new StringBuffer();
		try {
			URL url = new URL("https://dapi.kakao.com/v2/local/search/keyword.json" + "?category_group_code={}page=" + page + "&query=" + URLEncoder.encode(keyword, "UTF-8"));
